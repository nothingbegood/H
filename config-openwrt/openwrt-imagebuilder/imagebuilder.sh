...
download_imagebuilder() {
    ...
    download_file="https://downloads.openwrt.org/releases/22.03.3/targets/armvirt/64/openwrt-imagebuilder-22.03.3-armvirt-64.Linux-x86_64.tar.xz"
...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        dockerd dosfstools dumpe2fs e2freefrag e2fsprogs exfat-mkfs \
        ...
        tini tune2fs uclient-fetch uhttpd uhttpd-mod-ubus unzip uqmi usb-modeswitch \
